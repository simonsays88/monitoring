...
class ResultsController extends Controller
{
    ...
    public function replyAction(Request $request, $result_id)
    {
        ...
        $message = $this->container->get('templating')->render('AppBundle:Emails:reply.html.twig', array('text_reply' => htmlentities(nl2br($request->query->get('text_reply'))), 'initial' => $pack->getInitial()));
